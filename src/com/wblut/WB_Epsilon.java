...
public class WB_Epsilon {
	...
	/** Plane thickness. */
	static public double PLANE_EPSILON = 1e-12;
	/** Random point jitter. */
	static public double JITTER_EPSILON = 1e-2;
	static public double ANGLE_EPSILON = Math.PI / 18000;
	...
	public static boolean isZeroAngle(final double x) {
		return WB_Fast.abs(x) <= WB_Epsilon.ANGLE_EPSILON;
	}
